SET PDIPATH=D:\mifos\mifosx_migration_project\data-integration
SET KETTLEPATH=D:\mifos\mifosx_migration_project\move-to-mifosx\KettleJobs

:: location where source database dump is located, comment below line if source DB is already restored
:: bSET SOURCEDUMP=E:\Projects\Clients\secdep\secdepx\move-to-mifosx\source_db_dump\source.sql
SET DESTDB=mifosx
SET SOURCEDB=mifos
